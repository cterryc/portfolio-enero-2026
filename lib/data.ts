import type { ProjectStat, SkillCategory, Commit } from './types'

// Project Stats
export const projectStats: ProjectStat[] = [
  { label: 'Performance', val: '98%', color: 'text-primary' },
  { label: 'SEO', val: '100%', color: 'text-primary' },
  { label: 'Accessibility', val: '96%', color: 'text-white' },
  { label: 'Commits', val: '450+', color: 'text-white' }
]
